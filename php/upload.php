...
if($_SERVER['REQUEST_METHOD'] == "POST" && isset($_FILES["imagenProducto"]["type"])){
$target_dir = "../img/tmp/";
$carpeta=$target_dir;
...
$target_file = $carpeta . basename($_FILES["imagenProducto"]["name"]);
$uploadOk = 1;
...
// Check file size
if ($_FILES["imagenProducto"]["size"] > 524288) {
